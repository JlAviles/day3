...
//name2 now has natalia as its value, it is a copy, but NOT a link

name1 = "charly"
//this yields natalia still
console.log(name2)


var marks1 = [1, 3, 10, 8]
var marks2 = marks1
var marks3Unlinked = [...marks1]
...
//more experiments (made in chrome)
/*
var marks1 = [1, 3, 10, 8]
undefined
var marks2 = marks1.slice()
undefined
marks2
(4) [1, 3, 10, 8]
var marks3 = marks1.slice(2)
undefined
marks3
(2) [10, 8]
var marks4 = [...marks1]
...
//array generator with a number of positions with arbitrary values
[...new Array(50)].map((pos, idx) => {
	return {a: 5}
})